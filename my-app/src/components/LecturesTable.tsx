...
export default function LecturesTable(props: LectureTableProps) {
  return (
    <div className="mt-8 flex flex-col">
      ...
      <p>The listed lecture schedule is prospective and subject to change. All lecture capture videos can be found on our 2024 Canvas <a href="https://canvas.brown.edu/courses/1094402/external_tools/33943">media library page</a>. Notes can be found on our <a href="https://csci1710.github.io/book">Forge book deployment</a>, even if the specific chapters are not yet linked below.</p>
